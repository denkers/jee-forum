            ...
            <div class="container col-md-8 col-md-offset-2">
                <div class="panel panel-default board-panel">
                    <div class="panel-heading">
                        <button class="btn btn-default pull-right"><span class="glyphicon glyphicon-plus"></span> New Thread</button>
                        ...
                        <c:choose>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach items="${category.threadses}" var="thread">
                                            <tr>
                                                <td>
                                                    <strong><a href="#">${thread.title}</a><br></strong>
                            ...
                            <c:otherwise>
                                <div class="no-thread-container">
                                  ...
                                  <a href="#" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-plus"></span> Create new thread</a>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
